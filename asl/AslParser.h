...
public:
  ...
  enum {
    ...
    RuleStatement = 8, RuleForStmt = 9, RuleAssignSt = 10, RuleLeft_expr = 11, 
    RuleExpr = 12, RuleFuncCall = 13, RuleIdent = 14, RuleArray_access = 15
  };
  ...
  class  ForBlockContext : public StatementContext {
  public:
    ForBlockContext(StatementContext *ctx);
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<AssignStContext *> assignSt();
    AssignStContext* assignSt(size_t i);
    ExprContext *expr();
  ...
  class  AssignStContext : public antlr4::ParserRuleContext {
  public:
    AssignStContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    Left_exprContext *left_expr();
