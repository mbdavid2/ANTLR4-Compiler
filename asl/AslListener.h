...
public:
  ...
  virtual void enterType_basic(AslParser::Type_basicContext *ctx) = 0;
  virtual void exitType_basic(AslParser::Type_basicContext *ctx) = 0;
  ...
  virtual void enterForBlock(AslParser::ForBlockContext *ctx) = 0;
  virtual void exitForBlock(AslParser::ForBlockContext *ctx) = 0;
  ...
  virtual void enterForStmt(AslParser::ForStmtContext *ctx) = 0;
  virtual void exitForStmt(AslParser::ForStmtContext *ctx) = 0;

  virtual void enterAssignSt(AslParser::AssignStContext *ctx) = 0;
  virtual void exitAssignSt(AslParser::AssignStContext *ctx) = 0;
  ...
  virtual void enterFuncCall(AslParser::FuncCallContext *ctx) = 0;
  virtual void exitFuncCall(AslParser::FuncCallContext *ctx) = 0;
